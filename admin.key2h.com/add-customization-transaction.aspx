                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <span class="error">
                                                        <asp:RequiredFieldValidator
                                                            ...
                                                            Display="Dynamic" />
                                                        <%--<asp:RegularExpressionValidator ID="RegularFieldValidator1" runat="server" ControlToValidate="txtamount" ValidationGroup="projval" ValidationExpression="^(\u20B9|\₹)$" ErrorMessage="Enter a minimum amount of ₹1000" Display="Dynamic"></asp:RegularExpressionValidator>--%>
                                                    </span>
        ...
        <script>
            ...
            function keyup(txtID, lblID) {
                ...
                if (!selectedValue || !demandValue) {
                    alert('Flat ID and demand type are missing!');
                    return;
                }
                ...
                if (txtamt !== '')
                {
                    ...
                    if (!/^\d+(\.\d+)?$/.test(txtamt) || parseFloat(txtamt) === 0)
                    {
                        lblcustomernameerror.textContent = "Please enter a valid numeric amount greater than 0.";
                        return;
                    }
            ...
            function deleteRow(btn) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (!CTID) {
                            alert('CustomizationTransactionID is missing!');
                            return;
                        }
                        const dropFlatName = document.getElementById('<%= ddlFlatNumber.ClientID %>');
                        const selectedValue = dropFlatName ? dropFlatName.value : '';
