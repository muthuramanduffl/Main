...
public partial class adminkey2hcom_AddCustomizationDemand : System.Web.UI.Page
{
    ...
    public static string DeleteCustomisationDemands(string CDemandID, string selectedValue)
    {
        ...
        {
            CE.StoreExceptionMessage("add-customization-demand.aspx", "DeleteCustomer", ex.Message, "Not Fixed");
        }
        return strerror;
    }
    ...
    public int AddData()
    {
        ...
        {
            CE.StoreExceptionMessage("add-customization-demand.aspx", "AddCustomWorkdetails", ex.Message, "Not Fixed");
        }
        return rowaffected;
    }
