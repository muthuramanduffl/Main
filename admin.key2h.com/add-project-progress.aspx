<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-project-progress.aspx.cs" Inherits="adminkey2hcomaddprojectprogress" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div id="fileUploadRow1" class="file-upload-row d-flex align-items-start flex-wrap">
                                                <div class="col-sm-4 col-xl-4 pt-3">
                                                    <div class="input-icon input-icon-sm right">
                                                        ...
                                                        <asp:FileUpload ID="fileUpload" ClientIDMode="Static" accept=".jpeg, .jpg, .png"  class="form-control input-sm UploadMultipleImg progressImagesUpload flupload" autocomplete="off" placeholder="" runat="server" />
                                                        <span class="handle-file-request">(max file size of 500 KB)</span>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="form-group" id="divProjectprogressimages" style="display: none" clientidmode="Static" runat="server">
                                        <div class="form-border margin-top20">
                                            <div class="form-title">
                                                <h3>View Project Progress List</h3>
                                            </div>
                                            <div class="table-responsive pt-4 mt-md-2 mt-0 px-4">
                                                <asp:Repeater ID="rpProjectprogressimages" runat="server">
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr id="row<%# Container.ItemIndex %>">
                                                            <asp:HiddenField ID="HiddenField1" Value='<%# Eval("ProgressImageID") %>' ClientIDMode="Static" runat="server" />
                                                            <asp:HiddenField ID="HiddenField2" Value='<%# Eval("ProgressID") %>' ClientIDMode="Static" runat="server" />
                                                            <td><%# Container.ItemIndex + 1 %></td>
                                                            <td><%#Eval("Content") %></td>
                                                            <td>
                                                                <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('<%#"/ProgressImages/"+Eval("ImageName") %>'); return false;">
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fileUploader.addEventListener('change', function (event) {
                ...
                if (file) {
                    ...
                    if (!allowedFiles.includes("." + ext)) {
                        fileSizeErrorLabel.textContent = "Select .png, .jpg, or .jpeg files only.";
                        resetFileInput();
                        return;
                    }
                    if (file.size > maxFileSize) {
            ...
            function resetFileInput() {
                fileUploader.value = '';
                screensrc = null; // Corrected this line
                viewLogoBtn.style.display = 'none';
            }
        });
    </script>
        ...
        function deleteRow(btn) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const ProgressImageID = hiddenFields[0] ? hiddenFields[0].value : '';
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'add-project-progress.aspx/DeleteCustomer',
                        data: JSON.stringify({ ProgressImageID: ProgressImageID }),
                        ...
                        success: function (response) {
                            ...
                            if (rows.length === 0) {
                                const repeaterContainer = document.getElementById('<%= divProjectprogressimages.ClientID %>').closest('div');
                            ...
                            if (response.d == "1") {
                                Swal.fire({
                                    title: 'Project progress details have been deleted as requested', confirmButtonText: 'Ok',
                                    customClass: {
                                        confirmButton: 'handle-btn-success'
                                    },
                                });
                                ...
                                Swal.fire({
                                    title: 'Project progress details have been not deleted as requested', confirmButtonText: 'Ok',
                                    customClass: {
                                        confirmButton: 'handle-btn-success'
                                    },
                                });
    ...
    <script type="text/javascript">
        function loadRepeaterData(selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-project-progress.aspx/GetCostDetails',
                ...
                success: function (response) {
                  ...
                  <td>
                      <a href="javascript:void(0);" class="btnDelete" onclick="deleteRow(this)">
                        ...
                        const repeaterContainer = document.getElementById('<%= divProjectprogressimages.ClientID %>');
                        if (repeaterContainer) {
