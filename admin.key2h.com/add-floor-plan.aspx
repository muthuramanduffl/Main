<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-floor-plan.aspx.cs" Inherits="adminkey2hcom_AddFloorPlan" %>
       ...
       Digital</a>
        ...
        <script>
            ...
            function showImage(imageUrl) {
                Swal.fire({
                    title: '<h2 class="fw-bold">Image Preview </h2>',
                    html: `
            ...
            function deleteRow(btn) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'add-floor-plan.aspx/DeleteCustomer',
                            ...
                            success: function (response) {
                                ...
                                Swal.fire({
                                    title: 'Project floor plan has been deleted.', confirmButtonText: 'Ok',
                                    customClass: {
                                        confirmButton: 'handle-btn-success'
                                    },
                                }); 
        ...
        <script type="text/javascript">
            function loadRepeaterData(selectedValue) {
                $.ajax({
                    type: 'POST',
                    url: 'add-floor-plan.aspx/GetCostDetails',
