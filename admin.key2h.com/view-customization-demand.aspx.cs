...
public partial class adminkey2hcom_ViewCustomizationDemand : System.Web.UI.Page
{
    ...
    public void ddlBindProject()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "ddlBindProject", ex.Message, "Not Fixed");
        }
    }
    ...
    public string Bindproject(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "Bindproject", ex.Message, "Not Fixed");
        }
        return Project;
    }
    public string BindBlockname(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "BindBlockname", ex.Message, "Not Fixed");
        }
    ...
    public string ViewFlatNameByFlatID(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "ViewFlatNameByFlatID", ex.Message, "Not Fixed");
        }
        return Block;
    }
    public void Bind()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "Bind", ex.Message, "Not Fixed");
        }
    }
    public DataTable Get()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "Get", ex.Message, "Not Fixed");
        }
        return dt;
    }
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            try
            {
                ...
                Response.Redirect("add-customization-demand.aspx?FlatID=" + ID, false);
                HttpContext.Current.ApplicationInstance.CompleteRequest();
            }
            catch (Exception ex)
            {
                CI.StoreExceptionMessage("view-customization-demand.aspx", "Repeater1_ItemCommand Edit", ex.Message, "Not Fixed");
            }
        }
    ...
    public void Bindblock()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "Bindblock", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlat()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-demand.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
