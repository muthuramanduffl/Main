<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="view-cost-details.aspx.cs" Inherits="adminkey2hcom_ViewCostDetails" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>
                                        <asp:Repeater ID="rpruser" OnItemCommand="Repeater1_ItemCommand" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <asp:HiddenField ID="HiddenField1" Value='<%# Eval("CostID") %>' runat="server" />
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton class="edit-img me-3" data-bs-toggle="tooltip" title="Edit" ID="lkedit" runat="server" CommandName="Edit"
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CostID") %>'>
