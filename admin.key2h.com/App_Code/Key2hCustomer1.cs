...
public class Key2hCustomer1
{
    ...
    public int AddCustomerBasicDetails(Key2hCustomer1 KC)
    {
    ...
    public int UpdateCustomerBasicDetails(Key2hCustomer1 KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int AddFlatCustomerBookingDetails(Key2hCustomer1 KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("AddFlatCustomerBookingDetails", cnn))
            {
                ...
                command.Parameters.Add(new SqlParameter("@ReferedBy", KC.strRegistrationOffice));
                command.Parameters.Add(new SqlParameter("@Addedby", KC.strAddedBy));
                command.Parameters.Add(new SqlParameter("@AddedDate", Utility.IndianTime));
    ...
    public int UpdateFlatCustomerBookingDetails(Key2hCustomer1 KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int AddtblFlatCustomerBookingDetails(Key2hCustomer1 KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
