...
public class Key2hCustomeroldOLD
{
    ...
    public int AddCustomerBasicDetails(Key2hCustomeroldOLD KC)
    {
    ...
    public int UpdateCustomerBasicDetails(Key2hCustomeroldOLD KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int AddFlatCustomerBookingDetails(Key2hCustomeroldOLD KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int UpdateFlatCustomerBookingDetails(Key2hCustomeroldOLD KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int AddtblFlatCustomerBookingDetails(Key2hCustomeroldOLD KC)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
