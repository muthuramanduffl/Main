<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-cost-detailsold.aspx.cs" Inherits="adminkey2hcom_AddCostDetails" %>
                                                ...
                                                <asp:Repeater ID="rptCustomers" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="lblCost"><p><%#"₹" + Eval("Cost") %></p> </div>
    ...
    <script type="text/javascript">
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            Swal.fire({
                                title: 'Cost details has been deleted', confirmButtonText: 'Ok',
                                customClass: {
        ...
        function checkRowCountAndToggleDisplay() {
            ...
            $.ajax({
                ...
                data: JSON.stringify({ selectedValue: selectedValue, Selectedddlproject: Selectedddlproject, selectedBlock: selectedBlock }),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (response) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response && response.d) {
                        ...
                        <td> 
                            <a href="javascript:void(0);" class="btnEdit me-3" data-bs-toggle="tooltip" title="Edit" onclick="editRow(this)"><i class="bi bi-pencil-square b5-icon-et-dlt"></i></a>
