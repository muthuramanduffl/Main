...
public partial class adminkey2hcom_ViewCostDetails : System.Web.UI.Page
{
    ...
    public void ddlBindProject()
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "ddlBindProject", ex.Message, "Not Fixed");
        }
    }
    ...
    public string Bindproject(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "Bindproject", ex.Message, "Not Fixed");
        }
        return Project;
    }
    public string BindBlockname(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "BindBlockname", ex.Message, "Not Fixed");
        }
    ...
    public string ViewFlatNameByFlatID(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "ViewFlatNameByFlatID", ex.Message, "Not Fixed");
        }
    ...
    public void Bind()
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "Bind", ex.Message, "Not Fixed");
        }
    }
    public DataTable Get()
    {
        ...
        try
        {
            ...
            dt = KD.ViewAllFlatCostDetails(projectid, FlatID, blockID, "");
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "Get", ex.Message, "Not Fixed");
        } 
        return dt;
    }
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            try
            {
                ...
                Response.Redirect("add-cost-details.aspx?CostID=" + ID, false);
                HttpContext.Current.ApplicationInstance.CompleteRequest();
            }
            catch (Exception ex)
            {
                CI.StoreExceptionMessage("add-cost-details.aspx", "Repeater1_ItemCommand Edit", ex.Message, "Not Fixed");
            }
        }
        else if (e.CommandName == "Delete")
        {
            try
            {
                ...
                if (ret >= 1)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                     "Swal.fire({ " +
                     "  title: 'Cost details has been deleted', " +
                     "  confirmButtonText: 'OK', " +  // Note the comma here
                     "  customClass: { " +
                ...
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                      "Swal.fire({ " +
                      "  title: 'Your cost details not deleted. please try again', " + 
            ...
            {
                CI.StoreExceptionMessage("add-cost-details.aspx", "Repeater1_ItemCommand Delete", ex.Message, "Not Fixed");
            }
        }
    }
    ...
    public void Bindblock()
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "Bindblock", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlat()
    {
        ...
        {
            CI.StoreExceptionMessage("add-cost-details.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
