...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                            <ContentTemplate>
                                                <div class="input-icon input-icon-sm right">
                                                    ...
                                                    <i class="bi bi-journal-bookmark-fill b5-icon"></i>
                                                    <asp:DropDownList class="bs-select form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlBlockName_SelectedIndexChanged" ID="ddlBlockName" runat="server">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                            <ContentTemplate>
                                                <div class="input-icon input-icon-sm right">
                                                    ...
                                                    <i class="bi bi-journal-bookmark-fill b5-icon"></i>
                                                    <asp:DropDownList class="bs-select form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlFlatNumber_SelectedIndexChanged" ID="ddlFlatNumber" runat="server">
                                                        <asp:ListItem Value="All">All</asp:ListItem>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        <asp:Repeater ID="rpruser" OnItemCommand="Repeater1_ItemCommand" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <asp:HiddenField ID="HiddenField1" ClientIDMode="Static" Value='<%# Eval("FlatProgressID") %>' runat="server" />
                                                    <td>
                                                    ...
                                                    <td>
                                                        <%#BindBlockname(Convert.ToInt32(Eval("BlockID"))) %>                                            
                                                    </td>
                                                    <td>
                                                        <%#ViewFlatNameByFlatID(Convert.ToInt32(Eval("FlatID"))) %>                                            
                                                    </td>
                                                    <td>
                                                        <asp:HiddenField ID="HiddenField2" Value='<%# Eval("FlatProgressID") %>' runat="server" />

                                                        <a href="#" class="me-3" data-bs-toggle="tooltip" title="View" onclick="showImage('<%#"/FlatProgressThumbnailimage/"+ Eval("ThumbnailImage") %>'); return false;">
                                                        ...
                                                        <asp:LinkButton CssClass=" " ID="Editbtn" runat="server" CommandName="EditThumbnail" Visible="true"
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FlatProgressID") %>'><i class="bi bi-pencil-square b5-icon-et-dlt" data-bs-toggle="tooltip" title="Edit"></i></asp:LinkButton>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton class="me-3" ID="lkedit" runat="server" CommandName="Edit"
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FlatProgressID") %>'>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton2" CausesValidation="false" runat="server" class="dlt-img hidden" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("FlatProgressID") %>' Style="display: none">
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            var fileUploader = document.querySelector('.file-upload');  // Only one uploader
            var errorLabel = document.querySelector('.error-label');    // Only one error label
            var screensrc = {};  // Store the image source
            var fileType = {};   // Store the file type
