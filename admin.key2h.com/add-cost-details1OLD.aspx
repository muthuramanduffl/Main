<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-cost-details1OLD.aspx.cs" Inherits="adminkey2hcom_AddCostDetails1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        .btnnext {
            ...
            color: #493700; /* Text and icon color */
            ...
            .btnnext:hover {
                ...
                color: #493700; /* Keep text and icon color */
            ...
            .btnnext i {
                ...
                color: inherit; /* Use the color defined in .btnnext */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <div class="align-items-end">
                                                    <asp:LinkButton ID="btngo" CssClass="btnnext" OnClick="LinkButton1_Click" runat="server">
        <span>Next</span>
    ...
    <script type="text/javascript">
        ...
        function updateRow(btn) {
            ...
            if (trimcost !== '' && trimcost !== '0') {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'add-cost-details1.aspx/UpdateCustomer',
        ...
        function checkRowCountAndToggleDisplay() {
            ...
            $.ajax({
                type: 'POST',
                url: 'add-cost-details1.aspx/GetRowCount',
                data: JSON.stringify({
    ...
    <script>
        ...
        function deleteCostDetail(costLabelID, selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-cost-details1.aspx/DeleteCustomer',
        ...
        function showDeleteConfirmation(costLabelID, selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-cost-details1.aspx/CheckExistProjectCostLabelsParameter',
    ...
    <script type="text/javascript">
        function loadRepeaterData(selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-cost-details1.aspx/GetCostDetails',
