<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-payment-schedule.aspx.cs" Inherits="adminkey2hcom_AddPaymentSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                    ...
                                    <div class="row mx-0 margin-top20 mb-4">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <span class="error">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" Display="Dynamic" runat="server" ValidationGroup="val"
                                                            ControlToValidate="ddlProName" EnableClientScript="false" InitialValue="" ErrorMessage="Select project name">
                                                        </asp:RequiredFieldValidator>
                                                    </span>
                                                </ContentTemplate>
                                                <Triggers>
                                            ...
                                            <div class="input-icon input-icon-sm right">
                                                ...
                                                <span class="error">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" Display="Dynamic" runat="server" ValidationGroup="val"
                                                        ControlToValidate="ddlBlockNumber" EnableClientScript="false" InitialValue="" ErrorMessage="Select block name">
                                                    </asp:RequiredFieldValidator>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-xl-3 pt-3">
                                            ...
                                            <span class="error">
                                                ...
                                                <asp:RequiredFieldValidator ClientIDMode="Static" Display="Dynamic" EnableClientScript="false" SetFocusOnError="true" ControlToValidate="ddlFlatNumber" ValidationGroup="val" ID="RequiredFieldValidator13" runat="server" ErrorMessage="Select flat no. "></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                        <div class="col-sm-4 col-xl-3 pt-3">
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-icon input-icon-sm right">
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtPercentage" AutoPostBack="true" EnableViewState="true" ClientIDMode="Static" MaxLength="5" OnTextChanged="txtPercentage_TextChanged"
                                                                    class="form-control input-sm" autocomplete="off" placeholder="">
                                                                </asp:TextBox>
    ...
    <i class="fas fa-arrow-right"></i>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                <ContentTemplate>
                                    <div class="form-group divrptCustomers" id="divrptCustomers" clientidmode="Static" runat="server">
                                        <div class="form-border margin-top20">
                                            <div class="form-title">
    ...
    <script>
        ...
        function deleteRow(btn) {
            Swal.fire({
                title: 'Deleting this Payment shedule will lead to deleting the demand details. Are you sure you want to proceed?',
                showCancelButton: true,
                confirmButtonText: 'Yes',
                cancelButtonText: 'No',
                customClass: {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: JSON.stringify({ hdnPSID: hdnPSID, selectedValue: selectedValue }),
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response && response.d) {
                        ...
                        const tableContainer = document.getElementById('<%= divrptCustomers.ClientID %>');
                        ...
                        if (data.length > 0) {
                            ...
                            // Dynamically create and append rows
                        ...
                        `;
                            ...
                            const tableContainer = document.getElementById('<%= divrptCustomers.ClientID %>').closest('div');
