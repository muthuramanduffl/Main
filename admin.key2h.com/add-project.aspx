                                    ...
                                    <div class="row mx-0 mb-4">
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Block" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                <ContentTemplate>
                                                    ...
                                                    <span class="error">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator113" Display="Dynamic" runat="server" InitialValue="" ControlToValidate="ddlstate" ValidationGroup="projval" ErrorMessage="Select state"></asp:RequiredFieldValidator>
                                                    </span>
                                                </ContentTemplate>
                                                <Triggers>
                                        ...
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Block" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                <ContentTemplate>
                                                    ...
                                                    <span class="error">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" Display="Dynamic" runat="server" InitialValue="" ControlToValidate="ddlcity" ValidationGroup="projval" ErrorMessage="Select city"></asp:RequiredFieldValidator>
                                                    </span>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ddlstate" EventName="SelectedIndexChanged" />
                                        ...
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                                ...
                                                <asp:TextBox runat="server" ID="txtlatitude" ClientIDMode="Static" MaxLength="15" class="form-control input-sm" autocomplete="off" placeholder=""></asp:TextBox>
                                            </div>
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="txtlatitude" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator103" runat="server" ErrorMessage="Enter latitude "></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                                ...
                                                <i class="bi bi-building b5-icon"></i>
                                                <asp:TextBox runat="server" ID="txtlongitude" ClientIDMode="Static" MaxLength="15" class="form-control input-sm" autocomplete="off" placeholder=""></asp:TextBox>
                                            </div>
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="txtlongitude" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator102" runat="server" ErrorMessage="Enter longitude "></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                        ...
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                                <label>BHK Types <span class="text-danger">*</span></label>
                                                <i class="bi bi-building b5-icon"></i>
                                                <asp:TextBox runat="server" ID="txtbhk" ClientIDMode="Static" MaxLength="15" class="form-control input-sm" autocomplete="off" placeholder=""></asp:TextBox>
                                            </div>
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="txtbhk" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator101" runat="server" ErrorMessage="Enter BHK types "></asp:RequiredFieldValidator>
                                            </span>
                                        </div>

                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                                <label>Square Feet Range <span class="text-danger">*</span></label>
                                                <i class="bi bi-building b5-icon"></i>
                                                <asp:TextBox runat="server" ID="txtsqft" ClientIDMode="Static" MaxLength="10" class="form-control input-sm" autocomplete="off" placeholder=""></asp:TextBox>
                                            </div>
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="txtflatsunits" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator104" runat="server" ErrorMessage="Enter sq.ft range "></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
