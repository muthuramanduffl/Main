...
public partial class adminkey2hcom_ViewCustomizationTransaction : System.Web.UI.Page
{
    ...
    public void ddlBindProject()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "ddlBindProject", ex.Message, "Not Fixed");
        }
    }
    ...
    public string Bindproject(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "Bindproject", ex.Message, "Not Fixed");
        }
        return Project;
    }
    public string BindBlockname(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "BindBlockname", ex.Message, "Not Fixed");
        }
    ...
    public void Bind()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "Bind", ex.Message, "Not Fixed");
        }
    }
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            try
            {
                ...
                Response.Redirect("add-customization-transaction.aspx?FlatID=" + ID, false);
                HttpContext.Current.ApplicationInstance.CompleteRequest();
            }
            catch (Exception ex)
            {
                CI.StoreExceptionMessage("view-customization-transaction.aspx", "Repeater1_ItemCommand Edit", ex.Message, "Not Fixed");
            }
        }
        else if (e.CommandName == "Delete")
        {
            ...
            ret =KWT.DeleteAllTransaction(ID);
            if (ret  > 0)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
     "Swal.fire({ " +
     "  title: 'All transaction details has been deleted', " + // Fix verb tense
     ...
     "});", true);
            ...
            else
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
     "Swal.fire({ " +
     "  title: ' Not all transaction details has been deleted due to a network issue.', " + // Fix verb tense
     "  confirmButtonText: 'OK', " +
     "  customClass: { " +
     "    confirmButton: 'handle-btn-success' " +
     "  } " +
    ...
    public void Bindblock()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "Bindblock", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlat()
    {
        ...
        {
            CI.StoreExceptionMessage("view-customization-transaction.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
