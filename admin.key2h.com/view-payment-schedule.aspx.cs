...
public partial class adminkey2hcom_ViewPaymentSchedule : System.Web.UI.Page
{
    ...
    public void ddlBindProject()
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "ddlBindProject", ex.Message, "Not Fixed");
        }
    } 
    ...
    public string Bindproject(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "Bindproject", ex.Message, "Not Fixed");
        }
        return Project;
    }
    public string BindBlockname(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "BindBlockname", ex.Message, "Not Fixed");
        } 
        return Block;
    }
    public string ViewFlatNameByFlatID(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "ViewFlatNameByFlatID", ex.Message, "Not Fixed");
        }
        return Block;
    }
    public void Bind()
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "Bind", ex.Message, "Not Fixed");
        } 
    }
    public DataTable Get()
    {
        ...
        try
        {
            ...
            dt = KPD.ViewFilterCustomerPaymentSchedule(projectid, FlatID, blockID, "");
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "Get", ex.Message, "Not Fixed");
        } 
        return dt;
    }
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            try
            {
                ...
                Response.Redirect("add-payment-schedule.aspx?PSID=" + ID, false);
                HttpContext.Current.ApplicationInstance.CompleteRequest();
            }
            catch (Exception ex)
            {
                CI.StoreExceptionMessage("view-payment-schedule.aspx", "Edit repeater command", ex.Message, "Not Fixed");
            }
        }
        else if (e.CommandName == "Delete")
        {
            ...
            {
                CI.StoreExceptionMessage("view-payment-schedule.aspx", "Delete repeater command", ex.Message, "Not Fixed");
            }
        }
    ...
    public void Bindblock()
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "Bindblock", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlat()
    {
        ...
        {
            CI.StoreExceptionMessage("view-payment-schedule.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
