<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="view-payment-schedule.aspx.cs" Inherits="adminkey2hcom_ViewPaymentSchedule" %>
        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex pb-2 align-items-left align-items-md-center flex-column flex-md-row justify-content-between">
                    <div class="d-flex">
                        <h2 class="text-white mb-0 fw-bold text-uppercase">View Payment Schedule</h2>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>
                                        <asp:Repeater ID="rpruser" OnItemCommand="Repeater1_ItemCommand" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <asp:HiddenField ID="HiddenField1" Value='<%# Eval("PSID") %>' runat="server" />
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton class="edit-img " data-bs-toggle="tooltip" title="Edit" ID="lkedit" runat="server" CommandName="Edit"
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "PSID") %>'>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton2" CausesValidation="false" runat="server" class="dlt-img hidden" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("PSID") %>' Style="display: none">
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
...
<script>
    function validatePage() {
        return Page_ClientValidate('val');
    }
    ...
    function initializeDeleteEvents() { 
        ...
        cancelButtons.forEach((cancelButton) => {
            const existingHandler = cancelButton.getAttribute('data-event-attached');
